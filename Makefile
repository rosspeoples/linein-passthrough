...
help:
	@printf '%s\n' \
	  ...
	  '  install-wireplumber      Install core files plus optional WirePlumber Lua helper' \
	  '  uninstall                Remove all installed files' \
	  '  uninstall-keep-wireplumber Remove installed files but keep WirePlumber Lua helper' \
...
uninstall-keep-wireplumber:
	./bin/linein-passthrough-uninstall --keep-wireplumber-lua
